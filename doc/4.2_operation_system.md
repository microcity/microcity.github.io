...
Suspend the execution if **Pause**![](../img/pause.svg) is clicked or return false is **Stop**![](../img/stop.svg) is clicked.
...
<a id='os.download' class='anchor'> os.download ([filepath]) </a>
